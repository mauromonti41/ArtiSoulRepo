...
struct HowToCareView: View {
    
    let title1 : LocalizedStringKey = "title_HowToCare"
    let quote1 : LocalizedStringKey = "quote_briefDescription2"
    let quote2 : LocalizedStringKey =  "quote_photoCare"
...
struct HowToCareView_Previews: PreviewProvider {
